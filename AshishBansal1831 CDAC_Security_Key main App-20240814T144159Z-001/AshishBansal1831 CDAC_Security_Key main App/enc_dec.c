...
static GtkWidget *User_ID_Label;
...
int main(int argc, char *argv[]) {
    ...
    User_ID_Label = gtk_entry_new();
    gtk_box_pack_start(GTK_BOX(login_page), User_ID_Label, FALSE, FALSE, 5);
...
static void on_login_button_clicked(GtkButton *button, gpointer user_data) {
    const gchar *username = gtk_entry_get_text(GTK_ENTRY(User_ID_Label));
